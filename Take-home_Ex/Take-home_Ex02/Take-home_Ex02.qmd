...
This box plot helps to understand the variability of prices among the different private property types in Singapore. My classmate has put in extra efforts to derive out the floor category from the source data which made it possible to create an interesting insight about the price patterns among different floor categories.
